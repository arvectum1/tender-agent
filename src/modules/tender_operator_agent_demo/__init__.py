...
from src.modules.tender_operator_agent_demo.d04_2_supply_evidence_patch import (
    install as _install_d04_2_supply_evidence_patch,
)
...
_install_d04_2_supply_evidence_patch()
